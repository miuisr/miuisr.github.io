                    ...
                    return (
                        se.isEnabled ||
                            ...
                            ((0 <= t.indexOf("touch") && Pe) || 0 <= t.indexOf("pointer")) &&
                                (B(i, De[0], xe, s, G), B(ve, De[2], Ye), B(ve, De[3], Ye), Z && B(i, "click", Qe, !1, !0), q && B(i, "click", ef), X && B(ve, "gesturestart", Ze), W && B(ve, "gestureend", $e), D && B(i, Oe + "enter", cf), I && B(i, Oe + "leave", df), R && B(i, Oe + "move", bf)),
                            (se.isEnabled = !0),
                            e && e.type && xe(e),
                            U && U(se)),
                        se
            ...
            ((ScrollTrigger.prototype.init = function init(S, C) {
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), vt)) {
                    ...
                    if (
                        ...
                        C && ((C.vars.lazy = !1), C._initted || (!1 !== C.vars.immediateRender && !1 !== S.immediateRender && C.duration() && C.render(0, !0, !0)), (Te.animation = C.pause()), (C.scrollTrigger = Te).scrubDuration(ne), (w = 0), (a = a || C.vars.id)),
                        At.push(Te),
                        ue &&
                            ...
                            if (!pe || r || e) {
                                ...
                                if ((t && ((M = k), (k = pe ? Pe() : u), ue && ((_ = w), (w = C && !ve ? C.totalProgress() : p))), le && !p && ie && !nt && !dt && ht && P < u + ((u - M) / (gt() - rt)) * le && (p = 1e-4), p !== d && Te.enabled)) {
                                    if (
                                        ...
                                        ve || (!q || nt || dt ? C && C.totalProgress(p, !!nt) : (q._dp._time - q._start !== q._time && q.render(q._dp._time - q._start), q.resetTo ? q.resetTo("totalProgress", p, C._tTime / C._tDur) : ((q.vars.totalProgress = p), q.invalidate().restart()))),
                                        ie)
                                    )
